package com.example.user.androidstreaming;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        goCoder = WowzaGoCoder.init(getApplicationContext(), "GOSK-E644-0103-9708-0645-D8B2");
        ...
        goCoderBroadcastConfig.setUsername("apirak");
        goCoderBroadcastConfig.setPassword("12345aaa");
